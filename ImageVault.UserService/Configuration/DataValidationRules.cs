...
public class DataValidationRules
{
    ...
    {
        validationService.AddCustomValidationRule<string>("ValidateName", (str) =>
        {
            return str.All(char.IsLetter);
        });
        validationService.AddCustomValidationRule<string>("ValidateApplicationColorSchema", (str) => Enum.IsDefined(typeof(ApplicationColorSchemas), str));
        ...
        validationService.AddCustomValidationRule<string>("ValidateApiKeyName" , apiKeyName =>
        {
