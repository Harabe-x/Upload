...
public interface IApiKeyRepository
{
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains an <see cref="OperationResult{T}"/> indicating the success or failure of the operation, along with the created API key details.</returns>
    Task<OperationResult<Dtos.ApiKey>> AddKey(AddApiKey apiKeyData, string userId);
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains an <see cref="OperationResult{T}"/> with a collection of API keys associated with the user.</returns>
    Task<OperationResult<IEnumerable<Dtos.ApiKey>>> GetKeys(string userId);
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains an <see cref="OperationResult{T}"/> with the details of the requested API key.</returns>
    Task<OperationResult<Dtos.ApiKey>> GetKey(string key, string userId);
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains an <see cref="OperationResult{T}"/> indicating the success or failure of the operation, along with the updated API key details.</returns>
    Task<OperationResult<Dtos.ApiKey>> EditKey(EditApiKey newApiKeyData, string userId, string key);
    ...
    Task<OperationResult<bool>> DeleteKey(string key, string userId);
}
